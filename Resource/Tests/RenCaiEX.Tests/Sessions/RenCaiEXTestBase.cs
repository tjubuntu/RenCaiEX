...
namespace RenCaiEX.Tests.Sessions
{
    public abstract class RenCaiEXTestBase : AbpIntegratedTestBase
    {
        protected RenCaiEXTestBase()
        {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<RenCaiEXApplicationModule>();
            modules.Add<RenCaiEXDataModule>();
        }

        public void UsingDbContext(Action<RenCaiEXDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<RenCaiEXDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<RenCaiEXDbContext, T> func)
        {
            T result;
